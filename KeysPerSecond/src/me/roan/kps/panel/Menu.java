...
public class Menu {
	 ...
	 * The pause menu item
	 */
	public static final JCheckBoxMenuItem pause = new JCheckBoxMenuItem("Pause");
	 ...
	 */
	public static final void resetData(double oldScale){
		menu.removeAll();
		configure.removeAll();
		general.removeAll();
		precision.removeAll();
